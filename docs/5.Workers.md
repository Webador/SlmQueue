...
SlmQueue provides integration with the Laminas console routes and ease the use of workers. You can start a
...
*) assumed here is your working directory is the application root and your application is structured like the Laminas

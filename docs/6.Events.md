...
Note: since v1.0.1 we have decoupled from zendframework/zend-mvc and as such the shared event manager isn't available in the service container. If you are not using zend-mvc you should not use the shared event manager.
